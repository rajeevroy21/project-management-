  ...
  useEffect(() => {
    const fetchData = async () => {
      ...
      try {
        ...
        // Fetch uploaded data
        const uploadsResponse = await fetch('https://my-backend-api-ypqu.onrender.com/api/uploads/getfiles');
...
setFinalizedProjects(combinedData);
      ...
      try {
        ...
        for (let batchNo of batchNumbers) {
          try {
            ...
            const guideResponse = await fetch(`https://my-backend-api-ypqu.onrender.com/api/final/faculty/batch/${batchNo}`);
        ...
        const fetchProjectTitle = async (batchNumber) => {
          try {
            const response = await axios.get(`https://my-backend-api-ypqu.onrender.com/api/update/getTitle/${batchNumber}`);
  ...
  useEffect(() => {
    const fetchStudents = async () => {
      try {
        const response = await axios.get("https://my-backend-api-ypqu.onrender.com/api/students");
  ...
  useEffect(() => {
    const fetchUploadedData = async () => {
      ...
      setError(null);
      try {
        const response = await axios.get('https://my-backend-api-ypqu.onrender.com/api/uploads/getfiles');
    ...
    const fetchFacultyGuides = async () => {
      ...
      await Promise.all(Object.values(batches).map(async (batch) => {
        ...
        if (domain && domain !== "Unknown") {  
          try {
            const response = await axios.get(`https://my-backend-api-ypqu.onrender.com/api/domain-faculty/faculty/${domain}`);
