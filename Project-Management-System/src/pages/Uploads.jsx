...
function Documents() {
    ...
    const handleDelete = (fileName) => {
        fetch(`https://my-backend-api-ypqu.onrender.com/api/domain-faculty/files/${fileName}`, {
            method: "DELETE",
        })
            .then((response) => response.json())
            .then((data) => {
            ...
            <div className="max-w-4xl mx-auto space-y-6">
                ...
                <div className="grid md:grid-cols-3 gap-6">
                    ...
                    <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6 transition duration-200 hover:shadow-md">
                        ...
                        />
                        <button
                            onClick={() => handleFileUpload(selectedFile, "https://my-backend-api-ypqu.onrender.com/api/domain-faculty/upload", setMessage)}
                    ...
                    <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6 transition duration-200 hover:shadow-md">
                        ...
                        />
                        <button
                            onClick={() => handleFileUpload(guideFile, "https://my-backend-api-ypqu.onrender.com/api/final/uploadGuideInfo", setGuideMessage)}
...
<div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6 transition duration-200 hover:shadow-md">
    ...
    <button
        onClick={() =>
            handleFileUpload(
                adminFile,
                "https://my-backend-api-ypqu.onrender.com/api/section/uploadSecAlloc",
                setAdminMessage
            )
        }
    ...
    {adminMessage && <p className="text-green-600 mt-2 text-sm">{adminMessage}</p>}
                    ...
                    <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6 transition duration-200 hover:shadow-md">
                        ...
                        />
                        <button
                            onClick={() => handleFileUpload(studentFile, "https://my-backend-api-ypqu.onrender.com/api/alloc/uploadStudentInfo", setStudentMessage)}
