...
export default function Upload() {
  ...
  useEffect(() => {
    const fetchFiles = async () => {
      try {
        const response = await axios.get('https://my-backend-api-ypqu.onrender.com/api/uploads/files');
  ...
  const handleUpload = async () => {
    ...
    try {
      await axios.post('https://my-backend-api-ypqu.onrender.com/api/uploads', formData, {
        headers: {
  ...
  const handleDownload = (fileName) => {
    ...
    link.href = `https://my-backend-api-ypqu.onrender.com/api/uploads/files/${fileName}`; // Updated to match the download route
  ...
  const handleDelete = async (fileName) => {
    try {
      await axios.delete(`https://my-backend-api-ypqu.onrender.com/api/uploads/files/${fileName}`);
